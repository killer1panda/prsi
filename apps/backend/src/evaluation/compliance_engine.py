    ...
    def generate_eu_ai_act_dossier(self, audit_metrics: Dict[str, Any]) -> str:
        ...
        dossier = {
            ...
            "risk_management_art9": {
                "residual_risks_identified": audit_metrics.get(
                    "residual_risks", ["Contextual sarcasm ambiguity"]
                ),
            ...
            "data_governance_art10": {
                ...
                "intersectional_fairness_disparity": audit_metrics.get(
                    "intersectional_disparity", 0.04
                ),
                "privacy_budget": {
