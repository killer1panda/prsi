...
const LiveFeedPanel = () => {
  ...
  return (
    <Card className="bg-zinc-900/50 border-rose-900/20 shadow-2xl">
      ...
      <CardContent
        className="p-0 max-h-[280px] overflow-y-auto outline-none focus-visible:ring-2 focus-visible:ring-rose-500/50 rounded"
        tabIndex={0}
        role="region"
        aria-label="Live threat events feed"
      >
        {events.length === 0 ? (
    ...
    <Card className="bg-zinc-900/50 border-rose-900/20 shadow-2xl">
      ...
      <CardContent className="space-y-3">
        <textarea
          ...
          aria-label="Input text for threat analysis"
          value={inputText}
