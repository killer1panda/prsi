...
// ⚡ Bolt: Wrapped in React.memo() to prevent cascading re-renders
// when the global score interval updates every 2 seconds.
...
// ⚡ Bolt: Wrapped in React.memo() to prevent cascading re-renders.
// onResult is wrapped in useCallback in the parent, making it stable.
