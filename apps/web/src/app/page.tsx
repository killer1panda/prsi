...
// ⚡ Bolt: Wrapped LiveFeedPanel in React.memo() to prevent unnecessary
// re-renders triggered by the parent's (ThreatIntelligenceDashboard)
// 2-second polling interval for the global doom score.
...
// ⚡ Bolt: Wrapped ThreatAnalyzer in React.memo() to prevent cascading
// re-renders from the parent component.
