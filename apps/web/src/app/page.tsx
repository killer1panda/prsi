...
// ⚡ Bolt: Wrapped in React.memo() to prevent unnecessary cascading re-renders.
...
// ⚡ Bolt: Wrapped in React.memo() to prevent unnecessary re-renders triggered by top-level polling intervals.
