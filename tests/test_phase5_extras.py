...
from src.models.calibration import FollowerStratifiedCalibrator, CalibrationAnalyzer
from src.models.meme_detector import MemeDetector
from src.attacks.adversarial_production import VisualVenomInjector, ImageAttackResult
...
def test_meme_stream_exposure_aggregation():
    ...
    posts = [
        {"id": "p1", "image_url": "http://img1.jpg", "meme_data": {"is_meme": True, "virality_score": 0.85, "meme_type": "drake"}},
        {"id": "p2", "image_url": "http://img2.jpg", "meme_data": {"is_meme": True, "virality_score": 0.70, "meme_type": "distracted_bf"}},
        {"id": "p3", "image_url": "http://img3.jpg", "meme_data": {"is_meme": False, "virality_score": 0.10, "meme_type": "original"}},
